...
SECRET_KEY = 'django-insecure-&q&-zd2hu)vrk@b@ct!%-3v4(cu#9e@82fyi53w=a3je=578a9'
...
# Diretório de mídia (onde as imagens serão salvas)
MEDIA_URL = '/media/'
...
AUTHENTICATION_BACKENDS = ['users.authentication_backends.EmailBackend']
